...
Before start creating the lambda function, let us get some over view of AWS lambda.
...
Lambda supports popular programming langugages like node.js,python,ruby, java etc ( The complete details can be found from the link - https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html).

We will develop our lambda function in python.
